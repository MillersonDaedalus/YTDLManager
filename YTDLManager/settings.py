"""
Django settings for YTDLManager project.
...
SECRET_KEY = 'django-insecure-gfu#sj&11v4&fzc42tocmd=&xp^cl2%m9*!dcrub^!5l%_@b(h'
...
WSGI_APPLICATION = 'YTDLManager.wsgi.application'
